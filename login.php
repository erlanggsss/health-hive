...
<body>
    ...
    <div class="center">
        <div class="mt-4 login">
            <h3 class="text-heading p-4">Login</h3>
            <div class="container">
                <form action="" class="p-3">
                    ...
                    <div class="row">
                        <div class="col d-flex">
                            <div class="mb- me-3">
                                <label for="exampleInputPassword1" class="form-label text-heading">Captha</label>
                                <input type="text" class="form-control captha" id="exampleInputPassword1">
                            </div>
                            <div class="my-2">
                                <label for="exampleInputPassword1" class="form-label"></label>
                                <input type="text" class="form-control input-captha" id="exampleInputPassword1">
                            </div>
                        </div>
                    </div>
                    <div class="mt-5 d-flex flex-column justify-content-center align-items-center">
                        <button type="submit" class="btn btn-success px-4 mb-2">Masuk</button>
                        <a href="lupa.php" class="text-heading">lupa password</a>
                    </div>
                </form>
            </div>
        </div>
